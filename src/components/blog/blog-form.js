...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://salatumanuvao.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://salatumanuvao.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch"
      });
    }
  }
  ...
  handleSubmit(event) {
    axios({
      ...
      .then(response => {
        ...
        if (this.props.editMode) {
            // Update blog detail
            this.props.handleFormUpdateSubmission(response.data.portfolio_blog);
        } else {
